...
import com.gmailapi.GmailBounceEmailParser;
...
public class GmailInboxReader {
	...
	public static final String GOOGLE_CLIENT_ID = "99859280052-3sphtt6ktenfjlhl4i8aanldlg4nfb6p.apps.googleusercontent.com";
	public static final String GOOGLE_CLIENT_SECRET = "18sqedhAx_7y3_FsjcBJTh0g";
	public static final String GOOGLE_REDIRECT_URL = "[\"urn:ietf:wg:oauth:2.0:oob\",\"http://localhost\"]";
...
//=========================================================================================================================================================================================
		...
		public static List getEmailList(String token) throws IOException{ 
			...
			List msgidlist= GmailBounceEmailParser.parse(jsonString);		// call parser
			return msgidlist;
		}
		...
		public static List getEmails(String token) throws IOException {
			...
			for (int i = 0; i < finallist.size(); i++) {
				...
				List emailList = getEmailList(snippet);
				if(emailList.size() > 0){
		...
		public static void gmailBodyDecoder() throws Exception{
			  byte[] decodedmail = Base64.decodeBase64("PASTE YOUR GMAIL BODY IN BASE64URL FORMAT");
			  String s = new String(decodedmail);
			  System.out.println("decodedmail: " +s.toString());
			  List emailList = getEmailList(s);
